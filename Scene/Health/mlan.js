  ...
  return (
    <SafeAreaView style={{ flex:1 ,backgroundColor:'white',alignItems:'center'}}>
      ...
      onPress={()=>this.changeColor(1)}>
        <Text style={{ fontSize:12, fontWeight: '300', color: this.state.buttons[1].status==1?'#FFFFFF': '#999999' }}>英语</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{
      ...
      onPress={()=>this.changeColor(2)}>
        <Text style={{ fontSize:12, fontWeight: '300', color:this.state.buttons[2].status==1?'#FFFFFF': '#999999' }}>粤语</Text>
      </TouchableOpacity>
      <TouchableOpacity style={{
