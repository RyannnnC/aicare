              ...
              .then((json) => {
                if (json.code == 0) {
                  ...
                  if(json.data.payResult=="PAY_SUCCESS"){
                    this.props.navigation.navigate("teleSuccess",{docName:this.props.route.params.docName,doctype:1,startTime:this.props.route.params.startTime,endTime:this.props.route.params.endTime,teleFlg:2,mobile:"0426804898",method:1 })
